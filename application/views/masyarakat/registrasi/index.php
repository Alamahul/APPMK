        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <?= validation_errors(); ?>
              <form class="user" method="post" action="<?= base_url(); ?>Registrasi_Masyarakat/registrasi"><div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" placeholder="Masukan Nama Lengkap Anda..." name="nama">
                  </div>
                  <div class="col-sm-6">
                ...
                <hr>
                <a href="<?= base_url(); ?>masuk_masyarakat" class="btn btn-google btn-user btn-block">
