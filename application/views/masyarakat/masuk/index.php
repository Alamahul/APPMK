        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form class="user" method="post" action="<?= base_url(); ?>Masuk/proses_masuk">
                ...
                <hr>
                <a href="<?= base_url(); ?>registrasi_masyarakat" class="btn btn-google btn-user btn-block">
                  <i class="fas fa-registered fa-1x float-left"></i> Belum punya Akun Silahkan Register
                </a>
                <a href="<?= base_url(); ?>masuk_petugas" class="btn btn-facebook btn-user btn-block">
                  <i class="fas fa-user-secret float-left"></i> Masuk Sebagai Petugas
                </a>
              </form>
              <hr>
            </div>
